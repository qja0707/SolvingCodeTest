...
const leftVisit = (root: TreeNode, result: number[]) => {
...
const rightVisit = (root: TreeNode, result: number[]) => {
  result.push(root.val)
...
const node: TreeNode[] = [new TreeNode(0), new TreeNode(1), new TreeNode(2), new TreeNode(3), new TreeNode(4), new TreeNode(5)]
